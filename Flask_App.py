...
app.config['MAIL_USERNAME'] = 'kollurubhavana2005@gmail.com'
app.config['MAIL_PASSWORD'] = 'sooegistmrydiagl'
app.config['MAIL_DEFAULT_SENDER'] = 'kollurubhavana2005@gmail.com'
...
def payment(doctor_id):
    ...
    if request.method == 'POST':
        ...
        session.pop('Health insurance', None)
        ...
        msg.body = f"Dear {name},\n\nThank you for booking an appointment with Patient Medical Services (PMS).\n\nYour appointment details are as follows:\n\nDoctor: {doctor_name}\nAppointment Date: {appointment_date}\nAppointment Time: {appointment_time}\n\nWe look forward to seeing you!\n\nBest regards,\nThe PMS Team"
        mail.send(msg)
